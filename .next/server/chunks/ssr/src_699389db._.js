...
const AudioPlayer = ({ audioUrl, title, className = '' })=>{
    ...
    const { containerRef, loadAudio, playPause, stop, seekTo, getCurrentTime, getDuration, setWaveformVolume, getWaveformVolume } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useWaveform$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useWaveform"])(getThemeAwareWaveformConfig());
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (audioUrl) {
            loadAudio(audioUrl);
        }
...
;
function Home() {
    const { selectedFile, processingStatus, progress, currentStep, error, separatedTracks, handleFileSelect, handleFileRemove, startProcessing, resetAll, handleDownload } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAudioProcessing$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAudioProcessing"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=src_699389db._.js.map