...
;
;
const AudioResults = ({ tracks, onDownload, onDownloadAll })=>{
    const [downloadingAll, setDownloadingAll] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
...
const useAudioProcessing = ()=>{
    ...
    const [memberId, setMemberId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const startDetection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        try {
            ...
            setProgress(30);
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`${API_BASE_URL}/app-check`, {
                    timeout: 5000
                });
            } catch (error) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stats$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["recordSeparation"])(fileName, instrumentNames, trackNames, memberId);
                } catch  {}
    ...
    const handleDownload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((trackId)=>{
        ...
        if (track && track.url) {
            ...
            try {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stats$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["recordDownload"])(1, memberId);
            } catch  {}
    ...
    const handleDownloadAll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        if (isAuthenticated) {
            try {
                ...
                if (typeof navigator !== 'undefined' && 'sendBeacon' in navigator) {
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/api/user/audio-files/download', {
                        outputSessionId,
                        count
                    });
                }
        ...
        try {
            const count = separatedTracks.length || 1;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stats$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["recordDownload"])(count, memberId);
        } catch  {}
        const link = document.createElement('a');
...
;
function Home() {
    const { selectedFile, processingPhase, progress, currentStep, currentStepDetails, error, separatedTracks, detectedInstruments, selectedInstruments, handleFileSelect, handleFileRemove, startDetection, handleInstrumentsSelected, resetAll, handleDownload, handleDownloadAll } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAudioProcessing$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAudioProcessing"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__284bc45f._.js.map