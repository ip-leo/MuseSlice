...
const ProcessingStatus = (param)=>{
    let { status, progress = 0, currentStep = '', currentStepDetails = '', error, estimatedTime, detectedInstruments = [] } = param;
    const getStatusIcon = ()=>{
        switch(status){
            case 'uploading':
            case 'processing':
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                status === 'processing' && detectedInstruments.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: detectedInstruments.map((instrument, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        "useAudioProcessing.useCallback[startDetection]": async ()=>{
            ...
            try {
                ...
                for(let i = 0; i < detectionSteps.length; i++){
                    ...
                    await new Promise({
                        "useAudioProcessing.useCallback[startDetection]": (resolve)=>setTimeout(resolve, 1000)
        ...
        "useAudioProcessing.useCallback[startSeparation]": async (instruments)=>{
            ...
            try {
                ...
                for(let i = 0; i < instruments.length; i++){
                    ...
                    setCurrentStep("Separating ".concat(instrument.name, "..."));
                    // Simulate detailed separation process for each instrument
                    const separationSteps = [
                        "Analyzing ".concat(instrument.name, " frequency range..."),
                        "Extracting ".concat(instrument.name, " from mix..."),
                        "Cleaning ".concat(instrument.name, " artifacts..."),
                        "Optimizing ".concat(instrument.name, " quality...")
                    ];
                    for (const step of separationSteps){
                        setCurrentStepDetails(step);
                        await new Promise({
                            "useAudioProcessing.useCallback[startSeparation]": (resolve)=>setTimeout(resolve, 800)
                ...
                instruments.forEach({
                    "useAudioProcessing.useCallback[startSeparation]": (instrument)=>{
                        if (instrument.subParts) {
                            instrument.subParts.forEach({
                                "useAudioProcessing.useCallback[startSeparation]": (part, index)=>{
                                    generatedTracks.push({
                                        id: "".concat(instrument.id, "-").concat(index),
                                        name: part,
                                        type: instrument.type,
                                        url: "/api/audio/".concat(instrument.type, "-").concat(index),
                                        duration: 180
                                    });
                                }
                            }["useAudioProcessing.useCallback[startSeparation]"]);
                            ...
                            generatedTracks.push({
                                ...
                                type: instrument.type,
                                url: "/api/audio/".concat(instrument.type),
                                duration: 180
                            });
                        }
                    }
...
_s(useAudioProcessing, "Dhdjp7vur67f3+78Yq/SuHQJPRk=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
_s(Home, "45A7HmTRFyXS1kxPgEoAFZ3dJlU=", false, function() {
    return [
...
//# sourceMappingURL=src_fdeb697a._.js.map