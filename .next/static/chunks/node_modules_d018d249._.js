...
function s(t, e) {
    ...
    for (const [t, n] of Object.entries(e))if ("children" === t && n) for (const [t, e] of Object.entries(n))e instanceof Node ? i.appendChild(e) : "string" == typeof e ? i.appendChild(document.createTextNode(e)) : i.appendChild(s(t, e));
...
class h extends e {
    ...
    renderSingleCanvas(t, e, i, s, n, r, o) {
        ...
        h.width = Math.round(i * a), h.height = Math.round(s * a), h.style.width = "".concat(i, "px"), h.style.height = "".concat(s, "px"), h.style.left = "".concat(Math.round(n), "px"), r.appendChild(h);
    ...
    renderChannel(t, e, i, s) {
        ...
        o.style.height = "".concat(a, "px"), n && s > 0 && (o.style.marginTop = "-".concat(a, "px")), this.canvasWrapper.style.minHeight = "".concat(a, "px"), this.canvasWrapper.appendChild(o);
        const h = o.cloneNode();
    ...
    render(e) {
        return t(this, void 0, void 0, function*() {
            ...
            if (this.wrapper.style.width = r ? "100%" : "".concat(n, "px"), this.scrollContainer.style.overflowX = this.isScrollable ? "auto" : "hidden", this.scrollContainer.classList.toggle("noScrollbar", !!this.options.hideScrollbar), this.cursor.style.backgroundColor = "".concat(this.options.cursorColor || this.options.progressColor), this.cursor.style.width = "".concat(this.options.cursorWidth, "px"), this.audioData = e, this.emit("render"), this.options.splitChannels) for(let i = 0; i < e.numberOfChannels; i++){
    ...
    renderProgress(t, e) {
        if (isNaN(t)) return;
        const i = 100 * t;
        this.canvasWrapper.style.clipPath = "polygon(".concat(i, "% 0%, 100% 0%, 100% 100%, ").concat(i, "% 100%)"), this.progressWrapper.style.width = "".concat(i, "%"), this.cursor.style.left = "".concat(i, "%"), this.cursor.style.transform = this.options.cursorWidth ? "translateX(-".concat(t * this.options.cursorWidth, "px)") : "", this.isScrollable && this.options.autoScroll && this.scrollIntoView(t, e);
    }
    exportImage(e, i, s) {
        return t(this, void 0, void 0, function*() {
...
class u extends a {
    ...
    exportImage() {
        return t(this, arguments, void 0, function*() {
            let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "image/png", e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1, i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "dataURL";
...
"[project]/node_modules/lucide-react/dist/esm/icons/drum.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Drum = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("drum", __iconNode);
;
 //# sourceMappingURL=drum.js.map
}),
"[project]/node_modules/lucide-react/dist/esm/icons/drum.js [app-client] (ecmascript) <export default as Drum>": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_d018d249._.js.map