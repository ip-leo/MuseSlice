...
function DashboardPage() {
    _s();
    const { user, logout, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const [isLoadingFiles, setIsLoadingFiles] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [simpleTotalFiles, setSimpleTotalFiles] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [simpleTotalDownloads, setSimpleTotalDownloads] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [simpleHistory, setSimpleHistory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const fetchUserAudioFiles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DashboardPage.useCallback[fetchUserAudioFiles]": async ()=>{
            try {
                ...
                if (response.ok) {
                    ...
                    try {
                        const s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stats$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deriveSimpleFromAudioFiles"])(data.audioFiles || []);
    ...
    }["DashboardPage.useCallback[fetchUserAudioFiles]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            if (user) {
                fetchUserAudioFiles();
            ...
            try {
                const s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stats$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadStats"])(user === null || user === void 0 ? void 0 : user.id);
                setSimpleTotalFiles(s.totalFiles);
                setSimpleTotalDownloads(s.totalDownloads);
                setSimpleHistory(s.history);
            } catch (e) {}
    ...
    const handleClearHistory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DashboardPage.useCallback[handleClearHistory]": async ()=>{
            if (!user) return;
            const confirmed = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : window.confirm('Clear your processing history? This cannot be undone.');
            if (!confirmed) return;
            try {
                setIsClearing(true);
                ...
                try {
                    if ("TURBOPACK compile-time truthy", 1) {
                        localStorage.removeItem("ms_stats:".concat(user.id));
    ...
    }["DashboardPage.useCallback[handleClearHistory]"], [
        user,
        fetchUserAudioFiles
    ]);
    const formatFileSize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DashboardPage.useCallback[formatFileSize]": (bytes)=>{
    ...
    }["DashboardPage.useCallback[formatFileSize]"], []);
    const formatDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DashboardPage.useCallback[formatDate]": (dateString)=>{
    ...
    }["DashboardPage.useCallback[formatDate]"], []);
    const getStatusColor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DashboardPage.useCallback[getStatusColor]": (status)=>{
            switch(status){
                case 'completed':
    ...
    }["DashboardPage.useCallback[getStatusColor]"], []);
    const totalDownloadsDb = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[totalDownloadsDb]": ()=>audioFiles.reduce({
                "DashboardPage.useMemo[totalDownloadsDb]": (sum, file)=>sum + file.downloadCount
            }["DashboardPage.useMemo[totalDownloadsDb]"], 0)
    }["DashboardPage.useMemo[totalDownloadsDb]"], [
        audioFiles
    ]);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: simpleHistory.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    lineNumber: 265,
                                    columnNumber: 15
                                }, this) : simpleHistory.map((item, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "p-6",
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    }, "".concat(item.timestamp, "-").concat(idx), false, {
                                        fileName: "[project]/src/app/dashboard/page.tsx",
                                        lineNumber: 281,
                                        columnNumber: 17
                                    }, this))
...
_s(DashboardPage, "kQWaGde4wp0ceg4dMWd2J1eWLcs=", false, function() {
    return [
...
//# sourceMappingURL=_38b84712._.js.map