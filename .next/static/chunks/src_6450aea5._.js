...
const AudioPlayer = (param)=>{
    ...
    // Get theme-aware waveform configuration
    const getThemeAwareWaveformConfig = ()=>{
    ...
    const { containerRef, loadAudio, playPause, stop, seekTo, getCurrentTime, getDuration, setWaveformVolume, getWaveformVolume } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useWaveform$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWaveform"])(getThemeAwareWaveformConfig());
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    // Reinitialize waveform when theme changes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AudioPlayer.useEffect": ()=>{
            if (audioUrl) {
                loadAudio(audioUrl);
...
_s(AudioPlayer, "cjzoOpFlypkpc/A2i+hAHixtxpk=", false, function() {
    return [
...
_s(useAudioProcessing, "h4Hid7DHhwOnyNtzkBH3CjBYx+Y=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
function Home() {
    _s();
    const { selectedFile, processingStatus, progress, currentStep, error, separatedTracks, handleFileSelect, handleFileRemove, startProcessing, resetAll, handleDownload } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAudioProcessing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAudioProcessing"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Home, "2qjOHbJG9XgoMetimXJlcWvsnFQ=", false, function() {
    return [
...
//# sourceMappingURL=src_6450aea5._.js.map