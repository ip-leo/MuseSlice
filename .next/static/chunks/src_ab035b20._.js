...
const AuthProvider = (param)=>{
    ...
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuthProvider.useMemo[user]": ()=>{
            if (!(session === null || session === void 0 ? void 0 : session.user)) return null;
            return {
                id: session.user.id || '',
                email: session.user.email || '',
                name: session.user.name || undefined,
                image: session.user.image || undefined,
                createdAt: session.user.createdAt || undefined
            };
        }
    }["AuthProvider.useMemo[user]"], [
...
_s1(AuthProvider, "SBVJsYcLykN/TxpdV/K/sDZ3biU=", false, function() {
    return [
...
//# sourceMappingURL=src_ab035b20._.js.map